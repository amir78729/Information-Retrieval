...
class SearchEngine:
    ...
    def main(self):
        ...
        while True:
            user_queries = input('enter a query (\"\\q\": quit the program)'.upper()).split()

            if user_queries[0] == '\\Q' and len(user_queries) == 1:
                break
            else:
                set_of_answers = []
                missing_words = []
